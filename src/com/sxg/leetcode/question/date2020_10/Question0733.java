 ...
 */
public class Question0733 {
    private int[] fwi = {1, 0, 0, -1};

    private int[] fwj = {0, 1, -1, 0};
    ...
    public int[][] floodFill(int[][] image, int sr, int sc, int newColor) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int index = 0; index < 4; index++) {
                ...
                if (tempi >= 0 && tempi < m && tempj >= 0 && tempj < n && image[tempi][tempj] == initColor) {
