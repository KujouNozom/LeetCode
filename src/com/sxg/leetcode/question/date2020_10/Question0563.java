...
public class Question0563 {
    ...
    private int function(TreeNode root) {
        ...
        int leftCount = function(root.left);
        int rightCount = function(root.right);
        this.sum += Math.abs(leftCount - rightCount);
